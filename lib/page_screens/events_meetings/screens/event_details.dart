  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: userProvider.getUser.uid == widget.event.uid
            ? [
                IconButton(
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: widget.event.title),
                  ],
                ),
              ),
            ),
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          ...
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      TextSpan(text: widget.event.startTime),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(text: widget.event.endTime),
                      ],
                    ),
                  ),
                ),
                              ...
                              Padding(
                                ...
                                child: Center(
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      final url = '${widget.event.meetingLink}';
